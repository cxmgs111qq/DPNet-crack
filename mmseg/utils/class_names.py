...
def iccv09_classes():
    return ['sky', 'tree', 'ground', 'grass', 'river',
                 'buliding', 'mount', 'people/car']
...
def gankong_classes():
    return ['sundries', 'hole','pole']

def gankong_palette():
    return [[0, 0, 0], [128, 0, 0], [0, 128, 0]]

def crack_classes():
    return ['asphalt pavement', 'crack']
    # return ['asphalt layer','damage pattern']
    # return ['roadway','split crack']
    # return ['ground pavement texture', 'crack in the pavement']
    # return ['road surface material', 'crack on the road surface']
...
def nyu1449_palette():
    return [[180, 120, 120], [6, 230, 230], [80, 50, 50], [4, 200, 3], [120, 120, 80], [140, 140, 140], [204, 5, 255],
             ...
             [255, 122, 8]]
def whut_road_classes():
    return ['road','pole', 'vegetation','building',
                 'sky','car', 'bicycle','person','obstacles', 'sidewalk',
                 'grass','bottle','paper','river']

def whut_road_palette():
    return [(128, 64, 128),(153, 153, 153),(107, 142, 35),(70, 70, 70),
    (70, 130, 180),(0, 0, 142),(119, 11, 32),(220, 20, 60),(102, 102, 156),
    (244, 35, 232),(46, 139, 87),(0, 95, 135), (255, 255, 224),(0, 171, 244)]
dataset_aliases = {
